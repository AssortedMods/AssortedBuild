...
public final class __MOD_CLASS__NeoForgeGameTests {

    private __MOD_CLASS__NeoForgeGameTests() {
    }

    @SubscribeEvent
    public static void registerGameTests(final RegisterEvent event) {
        event.register(Registries.TEST_FUNCTION, helper -> __MOD_CLASS__GameTests.forEach(
